...
- Добавлены недостающие библиотеки для сборки программы . Внесены исправления в отчет: В приходе и расходе по месяцам, будет указан месяц по каждой операции. Программа готова для сборки.

- Удалена пустая колонка в табличной части, добавлена колонка номер, добавлен фильтр (год, месяц, тип), исправлен адаптер даты, исправлена опечатка версии программы, внесены другие незначительные исправления программы.
